...
#BMI, children, smokerno have an influence over the dependent variable
#Drop sex variable
#keep region variable because it is part of research question
...
#Create the model again because dropped sex variable
...
#Model assumptions
#Linearity
#We can check linear correlaion
#if it exists between dependend and each independent variable
...
scatter.smooth(x = bmi,
               y = charges, 
               main = "Insurance charges for BMI",
               ylab = "Insurance charges (,000)",
               xlab = "BMI")
...
#We cant use scatter plot for catagorical data
attach(insurance_data)
plot(smoker,
     charges,
...
#5.692046e-22 , p-value < 0.05, data not normally distributed
...
#10+ indicates that vars are not needed and can be removed from model
